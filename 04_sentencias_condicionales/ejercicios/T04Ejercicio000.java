 ...
 * del artículo a vender, su precio base en euros (sin IVA) y la cantidadArticulos de
...
public class T04Ejercicio000 {
    public static void main(String[] args) {
        ...
        System.out.println("Introduzca la cantidadArticulos de articulos");
        cantidadArticulos = s.nextInt();
        s.close();
        double totalBase = precioBase * cantidadArticulos;
        ...
        System.out.printf("%-25s %25.2f %s\n", "Subtotal", (precioBase * cantidadArticulos),
                "€");
