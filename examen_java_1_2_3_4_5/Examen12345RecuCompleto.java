...
/*
 * Se quiere crear una aplicación que muestre en pantalla un menú de opciones
 * permitiendo que el usuario realice diferentes
 * operaciones con números enteros. La ejecución del programa finalizará
 * únicamente cuando el usuario elija la opción SALIR.
 * La aplicación requiere que se implementen, como mínimo, las siguientes
 * funciones. Deberá gestionarse de forma apropiada
 ...
 * b. función divisionEnteros(int a, int b): recibe dos valores numéricos de
 * tipo entero, calcula y muestra en pantalla el cociente y
 * el resto de la división entera.
 * c. función longitud(int num): recibe un valor de tipo numérico entero y
 * devuelve el número de dígitos que lo componen.
 * d. función invertir(int num): recibe un valor de tipo numérico entero y
 * devuelve el número invertido.
 * e. función sumaDivisores(int num): recibe un valor de tipo numérico entero y
 * devuelve la suma de los divisores propios del número dado.
 * Los divisores propios de un número son todos aquellos que lo dividen de forma
 * exacta excepto el propio número.
 * f. función amigos(int a, int b): recibe dos valores numéricos enteros y
 * devuelve true o false dependiendo de si ambos números son o no amigos.
 * Dos números son amigos si cada uno de ellos se obtiene sumando los divisores
 * propios del otro. Las siguientes parejas de números
 * son amigos 220 y 284, 1184 y 1210, 2620 y 2924.
 * g. función digitos(int num): recibe un valor numérico entero y muestra en
 * pantalla literalmente los dígitos que comprenden la cifra numérica.
 * Recuerda que deben tenerse en cuenta los ceros a la derecha.
 * Se muestra a continuación un vídeo de demostración de funcionamiento de la
 * aplicacion. Debe tenerse en cuenta que, para realizar el borrado de
...
public class Examen12345RecuCompleto {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 6:
                    ...
                    System.out.println("Introduzca un número:");
                    numeroA = s.nextInt();
                    System.out.println(digitosEnLetras(numeroA));
    ...
    private static String digitosEnLetras(int numero) {
        ...
        contadorDespues = longitud(invertido);
        diferenciaDigitos = contadorAntes - contadorDespues;
