...
public class T05Ejercicio19R16 {
  public static void main(String[] args) {
     ...
     * esta vacia
     * System.out.println("");// esto es para que haga salto de linea en cada linea
     * de altura
     * for (int j = i; j < (altura + 1); j++) {// esto imprime los espacios, aunque
     * la priimera linea tambien esta vacia
     * System.out.print(" ");
     * }
     * for (int k = 1; k <= i; k++) {
     * System.out.print(relleno);
    ...
    // System.out.print(" ");
    // }
    // for (columna = 1; columna <= incremento; columna++) { // j es columna -pinta
    // caracteres
    // System.out.print(relleno);
    // }
