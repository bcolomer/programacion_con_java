...
public class T03Ejercicio05 {
    public static void main(String[] args) {
        ...
        System.out
                .println("Introduce la base del rectangulo en centimetros utilizando el punto para separar decimales");
        ...
        System.out.println(
                "Introduce la altura del rectangulo en centimetros utilizando el punto para separar decimales");
        dato = System.console().readLine();
